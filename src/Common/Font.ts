export const FontStyle = {
  title1: { fontSize: 26, lineHeight: 36 },
  title2: { fontSize: 24, lineHeight: 34 },
  body1: { fontSize: 20, lineHeight: 29 },
  body2: { fontSize: 18, lineHeight: 27 },
  description1: { fontSize: 16, lineHeight: 24 },
